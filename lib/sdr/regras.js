...
// Entrada = funil principal "Urace", que ja recebe tudo; Comercial = funil
// "Comercial" criado pela equipe. Nada e criado: o executor so usa o que existe.
...
const KOMMO_MAPA = {
  ...
  etapas: {
    ...
    [ETAPAS_ENTRADA.AGUARDANDO_CONTEXTO]: 'conversation in progress',
    [ETAPAS_ENTRADA.SEM_SINAL]: 'Cold Leads',
    [ETAPAS_ENTRADA.AUTOMATICO]: 'Cold Leads',
    [ETAPAS_ENTRADA.RUIDO]: 'Suppliers',
    [ETAPAS_ENTRADA.NAO_CONTATAR]: 143,
    [ESTAGIOS.NOVO]: 'ENTRADA',
    [ESTAGIOS.QUALIFICANDO]: 'ENTRADA',
    [ESTAGIOS.HUMANO]: 'ATENDIMENTO',
    [ESTAGIOS.ETAPA1]: 'PROPOSTA',
    [ESTAGIOS.ETAPA2]: 'FECHAMENTO',
    [ESTAGIOS.CONFIRMADA]: 142,
    [ESTAGIOS.PERDIDO]: 'PERDIDO / NAO QUALIFICADO'
  },
