...
// Tudo roda num funil proprio, "Novo funil", criado pelo setup: os funis da
// equipe (Urace, Comercial e os demais) nao sao tocados. Dentro dele, as
// etapas de triagem fazem o papel da Entrada e as de venda, do Comercial.
// Numero = fechamento nativo do Kommo (142 ganho, 143 perdido).
const NOVO_FUNIL = 'Novo funil';

const KOMMO_MAPA = {
  pipelines: {
    [PIPELINES.ENTRADA]: NOVO_FUNIL,
    [PIPELINES.COMERCIAL]: NOVO_FUNIL
  },
  etapas: {
    [ETAPAS_ENTRADA.TRIAGEM]: 'Triagem',
    [ETAPAS_ENTRADA.AGUARDANDO_CONTEXTO]: 'Aguardando contexto',
    [ETAPAS_ENTRADA.SEM_SINAL]: 'Sem sinal comercial',
    [ETAPAS_ENTRADA.AUTOMATICO]: 'Automáticos (e-mails e códigos)',
    [ETAPAS_ENTRADA.RUIDO]: 'Ruído (spam e fornecedores)',
    [ETAPAS_ENTRADA.NAO_CONTATAR]: 143,
    [ESTAGIOS.NOVO]: 'Lead novo',
    [ESTAGIOS.QUALIFICANDO]: 'Em qualificação (robô)',
    [ESTAGIOS.HUMANO]: 'Atendimento humano',
    [ESTAGIOS.ETAPA1]: 'Reserva Etapa 1 (Pit ID)',
    [ESTAGIOS.ETAPA2]: 'Briefing Etapa 2',
    [ESTAGIOS.CONFIRMADA]: 142,
    [ESTAGIOS.PERDIDO]: 143
  },
  // Ordem das etapas no funil: o caminho do lead primeiro, o que nao e lead
  // no fim (fora da vista de quem vende).
  ordemEtapas: [
    'Triagem',
    'Aguardando contexto',
    'Lead novo',
    'Em qualificação (robô)',
    'Atendimento humano',
    'Reserva Etapa 1 (Pit ID)',
    'Briefing Etapa 2',
    'Sem sinal comercial',
    'Automáticos (e-mails e códigos)',
    'Ruído (spam e fornecedores)'
  ],
